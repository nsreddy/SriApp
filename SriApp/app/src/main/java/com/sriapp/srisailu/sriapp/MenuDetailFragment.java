package com.sriapp.srisailu.sriapp;
...
import com.sriapp.srisailu.sriapp.dummy.DummyContent;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
           // ((TextView) rootView.findViewById(R.id.menu_detail)).setText(mItem.content);
            ...
            ((TextView) rootView.findViewById(R.id.menu_detail)).setText(DummyContent.EventDetails.get(Integer.parseInt(mItem.id)-1).toString());
        }
